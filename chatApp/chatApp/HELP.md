...
* The original package name 'com.chat .chatApp' is invalid and this project uses 'com.chat.chatApp' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/3.3.9/reference/messaging/websockets.html)
